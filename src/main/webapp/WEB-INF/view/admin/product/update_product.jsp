                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <form:form method="post" action="/admin/product/update"
                                                ...
                                                <div class="col-md-6">
                                                    <c:set var="errorQuanlity">
                                                        <form:errors path="quantity" cssClass="invalid-feedback" />
                                                    </c:set>
                                                    <label class="form-label">Quantily:</label>
                                                    <form:input path="quantity" type="text"
                                                        class="form-control ${not empty errorQuanlity ? 'is-invalid' : ''} " />
                                                    ${errorQuanlity}
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form:select class="form-select" path="target">
                                                        ...
                                                        <form:option value="SINHVIEN-VANPHONG">Sinh vien - Van phong
                                                        </form:option>
                                                    </form:select>
                                                </div>
